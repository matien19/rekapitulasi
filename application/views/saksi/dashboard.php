        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h4 class="font-weight-bold text-dark mb-1">
                    Halo, <span class="text-gradient">Saksi!</span>
                </h4>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-4 col-12">
            <div class="card border-0 shadow-sm dashboard-card p-4 text-center h-100">
              ...
              <a href="<?= base_url('index.php/saksi/pilih_kategori') ?>" class="btn btn-gradient-primary btn-lg rounded-pill px-4">
        ...
        <div class="col-md-4 col-12">
            <div class="card border-0 shadow-sm dashboard-card p-4 text-center h-100">
                ...
                <a href="<?= base_url('index.php/saksi/data_suara') ?>" class="btn btn-lg rounded-pill px-4" style="background: linear-gradient(90deg, #28a745, #1e7e34); border: none; color: white;">
                    <i class="fas fa-eye mr-2"></i> Lihat Data
                </a>
            </div>
        </div>

         <!-- Lihat Hasil Input Suara -->
        <div class="col-md-4 col-12">
            <div class="card border-0 shadow-sm dashboard-card p-4 text-center h-100">
                <div class="icon-box icon-box-success mb-4">
                    <i class="fas fa-table"></i>
                ...
                <h5 class="font-weight-bold text-dark mb-2">Hasil Input Suara</h5>
                <p class="text-muted mb-4" style="font-size: 0.9rem;">
                    Jika ada kesalahan input suara bisa cek disini.
                </p>
                
                <a href="<?= base_url('index.php/saksi/hasil_suara') ?>" class="btn btn-lg rounded-pill px-4" style="background: linear-gradient(90deg, #28a745, #1e7e34); border: none; color: white;">
                    <i class="fas fa-eye mr-2"></i> Lihat Hasil Suara
                </a>
            </div>
        </div>
        ...
        <div class="col-md-4 col-12">
            <div class="card border-0 shadow-sm dashboard-card p-4 text-center h-100">
               ...
               <a href="<?= base_url('index.php/saksi/logout') ?>" class="btn btn-gradient-danger btn-lg rounded-pill px-4" onclick="return confirm('Apakah Anda yakin ingin logout?');">
